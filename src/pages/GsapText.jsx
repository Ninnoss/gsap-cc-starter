  ...
  useGSAP(() => {
    ...
    gsap.fromTo(
      ...
      },
      {
        ...
        y: 0,
        delay: 1,
        stagger: 0.1, // animate one after the other
      }
    );
  }, []);
  return (
    <main>
      ...
      <p className="mt-5 text-gray-500 para">
        Using these methods we can achieve various text animations and effects like fade in, fade out, slide
        in, slide out, and many more.
      </p>
