  ...
  return (
    <main>
      ...
      <p className="mt-5 text-gray-500">
        ...
        difference is that the <code>gsap.to()</code> method animates elements from their current state to a
        new state, while the <code>gsap.from()</code> method animates elements from a new state to their
        current state.
      </p>
